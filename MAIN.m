...
LVpar = [320. 0.68  40.  0.  0.10 60.  10. -5.]; 
RVpar = [100. 0.68  40.  0.  0.07 60.  10. -5.]; 
% max physical pressure / max Ca / V0 / P0 / Ed0 /  
LApar = [20.  0.19  0.15 30. 0.   0.07 65. 10. -5.];
RApar = [20.  0.18  0.15 30. 0.   0.06 65. 10. -5.];
% Vs0 / max Ca / V0 / P0 / Ed0 /
...
TVpar  = [1.5 4. 0.0 1.  0.]; 
PVvpar = [5.0 4. 1.0 0.  0.]; 
MVpar  = [1.5 4. 0.0 1.  0.];
AVpar  = [17. 4. 1.0 0.  0.1]; 
